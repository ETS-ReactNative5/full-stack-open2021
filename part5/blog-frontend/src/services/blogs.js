...
const addComment = async (blogPost, id) => {
  const response = await axios.put(`${baseUrl}/${id}/comments`, blogPost)
  return response.data
}

export default { getAll, createBlogEntry, setToken, updateLike, deleteBlog, addComment }